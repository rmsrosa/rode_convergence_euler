...
\begin{theorem}
    ...
    \begin{align}
        ...
        \left\|\partial_t f(t, x, y)\right\| & \leq c_1 + c_2\|x\| + c_3\|y\|^2, \\
    ...
    \end{align}
    in $(t, x, y)\in I\times \mathbb{R}^d\times \mathbb{R}^k$, for suitable constants $c_1, c_2, c_3, c_4, c_7 \geq 0$. Assume, further, that the noise $\{Y_t\}_{t\in I}$ is a semi-martingale process. Then, the Euler scheme is strongly convergent of order 1, i.e.
    \begin{equation}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        & \leq \mathbb{E}\left[\left\|\int_0^{t_j} \int_{\tau^N(s)}^s \left(c_1 + c_2 \|X_{\tau^N(\xi)}^N\| + c_3\|Y_{\xi^-}\|^2\right)\;\mathrm{d}\xi\;\mathrm{d}s\right\|\right] \\
        & \leq \Delta t_N\int_0^{t_j} \left(c_1 + c_2  \left(\mathbb{E}\left[\|X_0^N\|\right] + \mathbb{E}[C_M] \xi \right)e^{c_L \xi} + c_3\mathbb{E}\left[\|Y_{\xi^-}\|^2\right]\right)\;\mathrm{d}\xi \\
        & \leq \Delta t_N \left(c_1 t_j + \frac{c_2}{c_L} \left(\mathbb{E}\left[\|X_0\|\right] + c_0t_j + \mathbb{E}[C_M] t_j \right) e^{c_L t_j} + c_3\sup_{0 \leq \xi \leq t_j}\mathbb{E}\left[\|Y_{\xi^-}\|^2\right]\right).
    \end{align*}
