...
\begin{lem}
    ...
    \begin{equation}
        \label{defBHst}
        Y_{s, t} = s^\alpha Z_{s, t} - \alpha \int_0^s \tau^{\alpha-1}Z_{\tau, \tau}\;\mathrm{d}\tau.
    \end{equation}
...
\[
    \mathbb{E}\left[(Z_{s, t})^2\right] = C_H^2 \int_0^s \tau^{-2\alpha}(t - \tau)^{2\alpha}\;\mathrm{d}\tau \\
...
\begin{proof}
    ...
    \begin{align*}
        f(s, Y_s) & = f(0, Y_0) + \int_{0}^s \frac{\partial f}{\partial \tau}(\tau, X_{\tau^N(s)}^N, B_{\tau, s})\;\mathrm{d}\tau \\ 
        & \quad + \alpha \int_{0}^s \frac{\partial f}{\partial y}(\tau, X_{\tau^N(s)}^N, B_{\tau, s})\tau^{\alpha - 1} (Z_{\tau, s} - Z_{\tau, \tau})\;\mathrm{d}\tau \\
    ...
    \[
        f(s, Y_s) = f(0, Y_0) + \int_0^s G(\tau, s)\;\mathrm{d}\tau + \int_0^s H(\tau, s)\;\mathrm{d}W_{\tau}.
    \]
...
\begin{proof}
    ...
    \begin{align*}
        & \int_0^t \left(f(s, X_{\tau^N(s)}^N, Y_s) - f(\tau^N(s), X_{\tau^N(s)}^N, Y_{\tau^N(s)})\right)\;\mathrm{d}s \\
        & \quad = \int_0^t\int_{\tau^N(s)}^{s} G(\tau, s) \;\mathrm{d}\tau\;\mathrm{d}s + \int_0^t\int_0^{\tau^N(s)} (G(\tau, s) - G(\tau, \tau^N(s))) \;\mathrm{d}\tau\;\mathrm{d}s \\
        & \quad + \int_0^t\int_{\tau^N(s)}^{s} H(\tau, s) \;\mathrm{d}W_\tau\;\mathrm{d}s + \int_0^t\int_0^{\tau^N(s)} (H(\tau, s) - H(\tau, \tau^N(s))) \;\mathrm{d}W_\tau\;\mathrm{d}s.
    \end{align*}
    Using Fubini's Theorem,
    \begin{align*}
        & \int_0^t \left(f(s, X_{\tau^N(s)}^N, Y_s) - f(\tau^N(s), X_{\tau^N(s)}^N, Y_{\tau^N(s)})\right)\;\mathrm{d}s \\
        & \quad = \int_0^t\int_\tau^{\tau^N(\tau) + \Delta t_N} G(\tau, s) \;\mathrm{d}s\;\mathrm{d}\tau + \int_0^t\int_{\tau^N(\tau) + \Delta t_N}^t (G(\tau, s) - G(\tau, \tau^N(s))) \;\mathrm{d}s\;\mathrm{d}\tau \\
        & \quad + \int_0^t\int_\tau^{\tau^N(\tau) + \Delta t_N} H(\tau, s) \;\mathrm{d}s\;\mathrm{d}W_\tau + \int_0^t\int_{\tau^N(\tau) + \Delta t_N}^t (H(\tau, s) - H(\tau, \tau^N(s))) \;\mathrm{d}s\;\mathrm{d}W_\tau.
    \end{align*}
