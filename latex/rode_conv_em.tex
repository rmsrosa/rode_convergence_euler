...
As for the numerics, \eqref{linearnonhomogeneousfbm} is implemented with several values of $H$. Table \ref{taborderdepHfBm} shows the obtained convergence, for a series of Hurst parameters.
...
Figure \ref{figorderdepHfBm} illustrates the dependency displayed in Table \ref{taborderdepHfBm}.
