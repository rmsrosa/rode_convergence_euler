...
\begin{proof}
    ...
    \begin{align*}
        ...
        & \leq \frac{c_7}{2}\Delta t_N \left([Y, Y]_{t_j}^c - [Y, Y]_{0}^c\right),
    \end{align*}
    where we used that $[Y, Y]_0^c$
    Taking the expectation,
    \[
        \mathbb{E}\left[\bigg\|\frac{1}{2} \int_0^{t_j} \int_{\tau^N(s)}^s D_{yy}f(\xi, X_{\tau^N(s)}^N, Y_{\xi^-})\;\mathrm{d}[Y, Y]_\xi^c\;\mathrm{d}s \bigg\|\right] \leq \frac{c_7}{2}\Delta t_N \mathbb{E}\left[[Y, Y]_{t_j}^c - [Y, Y]_{0}^c\right].
    \]
