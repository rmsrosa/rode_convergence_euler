...
\begin{proof}
    ...
    \begin{multline*}
        ...
        = \frac{C_H^2 L_Y^2}{1-2\alpha} (\tau^N(\xi) + \Delta t_N - \xi)^{1-2\alpha}.
    \end{multline*}
    ...
    \begin{multline}
        ...
        \leq t^{1/2}\frac{C_H L_Y}{(1-2\alpha)^{1/2}} (\Delta t_N)^{1-\alpha}.
    \end{multline}
    Since $\alpha = 1/2 - H$, this term yields order $H + 1/2$.
