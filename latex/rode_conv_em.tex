...
\begin{proof}
    ...
    \begin{equation*}
        \begin{aligned}
            ...
            & \quad + c_4\mathbb{E}\left[ V(\{F_t\}_{t\in I}; I) \right] + c_4\sup_{0\leq s \leq T} \mathbb{E}\left[ [Z, Z]_s\right] \\
            & \quad + \frac{c_7}{2} \mathbb{E}\left[\left\|\sum_{0 < s \leq T}\left( \Delta Y_s \right)^2\right\|\right] + \frac{c_7}{2} \sup_{0\leq s \leq T}\mathbb{E}\left[[Y, Y]_s^c\right].
        \end{aligned}
    \end{equation*}
    Thanks to \eqref{CMmeanbound}, \eqref{EX0strongbound}, \eqref{Y0finiteexpectation}, \eqref{expectFVFtfinite}, and \eqref{expectZtfinite}, the constant $C_T$ above is finite. Plugging \eqref{lasttermestimateforstrongconv} into \eqref{expectedestimateglobalerrorintegral} and applying \eqref{estimatesecondterminglobalerrorintegral} and \eqref{EX0X0Nunif} yield the desired order-one estimate \eqref{ordersemimartingaleunif}.
\end{proof}
