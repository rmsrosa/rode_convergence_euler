...
\]
either in the sense of a Riemann-Stieltjes integral or of an It\^o integral. The more general case of semi-martingales include more complicated terms, but the above is sufficient to give the main idea. With that, we bound the global error term using the Fubini Theorem,
\begin{multline*}
