...
In the more general case of semi-martingale, then $\{Y_t\}_{t\geq 0}$ has finite quadratic variation \cite[Section II.6]{Protter2005} on the bounded interval $I=[0, T],$ and we find that \comment{Check and give a more precise source}
\[
