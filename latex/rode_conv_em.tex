...
We ommit the proof since it is just a combination of \cref{lemmonotonicbound} and \cref{lemItostep}.
...
Here, we consider a population dynamics modelled by a logistic equation with a Wiener noise specific growth (loosely inspired by \cite[Section 15.2]{HanKloeden2017})and extra harvest term with a point process noise:
\begin{equation}
