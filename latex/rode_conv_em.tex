...
\begin{lemma}
    ...
    \end{equation}
    for some $\beta \geq 1,$ and that $\{L_t\}_{t\in I}$ is essentially bounded, uniformly on $I$, i.e. there exists a constant $L_X > 0$ such that $L_t \leq L_x$ almost surely for every $t\in I.$ Then,
    \begin{equation}
...
\begin{proof}
    By assumption \eqref{standinghypothesesMbound} of the \cref{standinghypotheses1}, we have almost surely that
    \[
