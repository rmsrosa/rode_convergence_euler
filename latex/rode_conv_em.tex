...
\begin{proof}
    ...
    \begin{multline}
        ...
        \mathbb{E}\left[\left\|\int_0^{t_j} \int_{\tau^N(s)}^s D_\xi f(\xi, X_{\tau^N(s)}^N, Y_{\xi^-})\;\mathrm{d}\xi\;\mathrm{d}s\right\|\right] \\
    ...
    \begin{align*}
        ...
        & \quad \leq \Delta t_N\int_0^{t_j} \left(c_4 + c_5 \mathbb{E}\left[\|X_{\tau^N(\xi)}^N\|\right] + c_6\mathbb{E}\left[\|Y_{\xi^-}\right]\|\right)\;\|\mathrm{d}F_\xi\| \\
        & \quad \leq \Delta t_N\left(c_4 + c_5 \max_{i=0, \ldots, j}\mathbb{E}\left[\|X_{i}^N\|\right] + c_6\sup_{0\leq \xi \leq t_j}\mathbb{E}\left[\|Y_{\xi}\|\right]\right)V(\{F_t\}_{t\in I}; [0, t_j]) \\
        & \quad \leq \Delta t_N\left(c_4 + c_5 \left(\mathbb{E}\left[\|X_0^N\|\right] + \mathbb{E}[C_M] \xi \right)e^{c_L \xi} + c_6\sup_{0\leq \xi \leq t_j}\mathbb{E}\left[\|Y_{\xi}\|\right]\right)V(\{F_t\}_{t\in I}; [0, t_j]).
    \end{align*}
