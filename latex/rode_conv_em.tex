...
Table \ref{tabpopdyn} shows the estimated strong error obtained for each mesh resolution, while Figure \ref{figpopdyn} illustrates the order of convergence, estimated to be of order 1.02, close enough to the theoretical value of strong order 1.
...
\[
  \ddot x + 2\zeta_g\omega_g \dot x - \omega_g^2 x = \ddot \xi,
\]
