...
As for the numerics, \eqref{linearnonhomogeneousfbm} is implemented with several values of $H$. Figure \ref{figorderdepfBm} shows the order of strong convergence obtained for each of a series of values of the Hurst parameter, compared with the expected value $p=\min\{H + 1/2, 1\}.$ 

\begin{figure}[htb]
    \label{figorderdepfBm}
