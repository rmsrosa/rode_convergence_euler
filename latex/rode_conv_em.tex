...
\title[Convergence of the Euler method for Random ODEs with semi-martingales]{Improved order of convergence of the Euler method for random ordinary differential equations driven by semi-martingale noises}
