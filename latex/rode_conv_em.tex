...
\]
where the quadratic variation process itself is defined by the limit
\[
...
\]
The quadratic variation is a c\`adl\`ag, increasing, and adapted process \cite[Theorem II.22]{Protter2005}.
...
For the quadratic variation part of a local martingale $\{Z_t\}_{t\in I},$ the Burkholder-David-Gundy inequality relates the moments of the maximum of the local martingale with moments of its quadratic variation,
\[
