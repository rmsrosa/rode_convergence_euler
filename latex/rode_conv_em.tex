...
\begin{figure}[htb]
    ...
    \includegraphics[scale=0.7]{img/sample_popdyn_gBmPoisson.png}
    \caption{An approximation sequence of a sample path of the solution process of the population dynamics equation \eqref{rodepopulationdynamics}.}
\end{figure}
