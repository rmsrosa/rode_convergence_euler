...
Before we estimate \eqref{singlestepwithfBm}, we need to estimate a few terms involving $Z_{\xi, s}$ and $Y_{\xi, s}$.
\begin{lem}
...
Now we are ready to estimate \eqref{singlestepwithfBm}
\begin{lem}
    \label{lemfBmsteps}
