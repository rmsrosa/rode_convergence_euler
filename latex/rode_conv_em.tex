...
\begin{align*}
    ...
    & \qquad\qquad \leq C_{T, H}\Delta t_N,
\end{align*}
for a suitable constant $C_{T, H}$. We see this term is order 1.
...
\begin{align*}
    ...
    & \qquad\qquad \leq C_{T, H}\Delta t_N,
\end{align*}
for a possibly different constant $C_{T, H}$. This term is also of order 1.
