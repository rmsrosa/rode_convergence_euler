...
\begin{figure}[htb]
    \includegraphics[scale=0.6]{img/order_earthquake.pdf}
...
\begin{figure}[htb]
    \includegraphics[scale=0.6]{img/order_riskmodel.pdf}
...
\begin{thebibliography}{25}
    ...
    \bibitem{RODEConvEM2023} P. Kloeden and R. Rosa, Numerical examples of strong order of convergence of the Euler method for random ordinary differential equations, \texttt{https://github.com/rmsrosa/rode\_convergence\_euler}.
