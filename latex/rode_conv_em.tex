...
\begin{equation}
    ...
    \int_0^t Z_s\;\mathrm{d}Y_s = \int_\mathbb{R} \left(\chi_{[0, t]} \;Z_s \right)\;\mathrm{d}Y_s = \int_\mathbb{R} \left(\chi_{[0, t]} \;Z_s \right)\diamond W_s^H \;\mathrm{d}s,
\end{equation}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        & \qquad + \int_0^t \int_\mathbb{R} \left(\chi_{[\tau^N(s), s]}\;\frac{\partial f}{\partial y}(\xi, X_{\tau^N(s)}^N, Y_\xi) \right) \diamond W_\xi^H \;\mathrm{d}\xi \;\mathrm{d}s \\
    ...
    \begin{equation}
        \begin{aligned}
            ...
            & \qquad + \int_0^t \int_\mathbb{R} \left(\chi_{[\tau^N(s), s]}\;\frac{\partial f}{\partial y}(\xi, X_{\tau^N(s)}^N, Y_\xi) \right) \diamond W_\xi^H \;\mathrm{d}s \;\mathrm{d}\xi \\
    ...
    \end{multline}
    As for the term with the WIS integral, we use that $W_t^H = M^H W_t$ and that $M^H$ is symmetric with respect \cite{BHOB2008} to write
    \begin{align*}
        \int_0^t \int_\mathbb{R} & \left(\chi_{[\tau^N(s), s]}\;\frac{\partial f}{\partial y}(\xi, X_{\tau^N(s)}^N, Y_\xi) \right) \diamond W_\xi^H \;\mathrm{d}s \;\mathrm{d}\xi \\
        & = \int_0^t \int_\mathbb{R} \left(\chi_{[\tau^N(s), s]}\;\frac{\partial f}{\partial y}(\xi, X_{\tau^N(s)}^N, Y_\xi) \right) \diamond M^H W_\xi \;\mathrm{d}s \;\mathrm{d}\xi \\
        & = \int_0^t \int_\mathbb{R} \left(M^H\left(\chi_{[\tau^N(s), s]}\;\frac{\partial f}{\partial y}(\xi, X_{\tau^N(s)}^N, Y_\xi) \right)\right) \diamond W_\xi \;\mathrm{d}s \;\mathrm{d}\xi.
    \end{align*} 
\end{proof}
