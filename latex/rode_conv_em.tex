...
\begin{proof}
    ...
    \begin{align*}
        ...
        & \qquad \leq \int_0^{t_j} \int_{\xi}^{\tau^N(\xi) + \Delta t_N} \left(c_4 + c_5 \|X_{\tau^N(s)}^N\| + c_6\|Y_{\xi^-}\|\right)\;\mathrm{d}s\;\|\mathrm{d}Y_\xi\| \\
        & \qquad \leq \Delta t_N\int_0^{t_j} \left(c_4 + c_5 \|X_{\tau^N(\xi)}^N\| + c_6\|Y_{\xi^-}\|\right)\;\|\mathrm{d}Y_\xi\| \\
        & \qquad \leq \Delta t_N\int_0^{t_j} \left(c_4 + c_5 \left(\|X_0\| + C_0\Delta t_N + C_M \xi \right)e^{C_L \xi} + c_6\|Y_{\xi^-}\|\right)\;\|\mathrm{d}Y_\xi\|.
    \end{align*}
