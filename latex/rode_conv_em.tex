...
\begin{lem}
    ...
    \begin{equation}
        ...
        \begin{aligned}
            f(t, B^H_t) & = f(0, B^H_0) + \int_{0}^t \frac{\partial f}{\partial s}(s, B_{s, t})\;\mathrm{d}s + \alpha \int_{0}^t \frac{\partial f}{\partial y}(s, B_{s, t})s^{\alpha - 1} (Y^H_{s, t} - Y^H_{s, s})\;\mathrm{d}s \\
...
\begin{lem}
    ...
    \begin{multline}
        G(\tau, s) = \frac{\partial f}{\partial \tau}(\tau, X_{\tau^N(s)}^N, B^H_{\tau, s})  + \alpha \frac{\partial f}{\partial y}(\tau, X_{\tau^N(s)}^N, B^H_{\tau, s})\tau^{\alpha - 1} (Y^H_{\tau, s} - Y^H_{\tau, \tau}) \\ 
...
\begin{proof}
    ...
    \begin{align*}
        ...
        & \quad + \alpha \int_{0}^s \frac{\partial f}{\partial y}(\tau, X_{\tau^N(s)}^N, B_{\tau, s})\tau^{\alpha - 1} (Y^H_{\tau, s} - Y^H_{\tau, \tau})\;\mathrm{d}\tau \\
