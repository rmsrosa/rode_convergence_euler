...
\subsection{Non-homogeneous linear system of RODEs with several types of noises}

Now we consider a system of linear equations, and with a number of different types of noises. For most of these noises, the current knowledge expects a lower order of strong convergence than the strong order 1 we prove here. The aim of this section is to illustrate this improvement at once, for all such noises.
