...
These two cases are treated in \cref{secmonotonicbound} and \cref{secsubmartingale}, with the bounded variation case in \cref{secmonotonicbound}, and the It\^o process noise case in \cref{secsubmartingale}.

The core results in these sections are \cref{thmcadlagfv}, for the pathwise convergence in the case of c\`adl\`ag, finite variation noises, and \cref{thmsemimartingale}, for the strong convergence of more general semi-martingale noises.
