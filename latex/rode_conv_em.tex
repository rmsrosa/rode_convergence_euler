...
\begin{align*}
    f(s, B^H_{s, t}) & = f(0, B^H_{0, t}) + \int_{0}^s \frac{\partial f}{\partial \tau}(t, B_{\tau, t})\;\mathrm{d}\tau + \alpha \int_{0}^s \frac{\partial f}{\partial y}(t, B_{\tau, t})\tau^{\alpha - 1} (Y^H_{\tau, t} - Y^H_{\tau, \tau})\;\mathrm{d}\tau \\
    & \quad + \frac{C_H^2}{2}\int_{0}^s \frac{\partial^2 f}{\partial y^2}(t, B_{\tau, t}) (t - \tau)^{2\alpha} \;\mathrm{d}\tau + C_H \int_{0}^s \frac{\partial f}{\partial y}(t, B_{\tau, t})(t - \tau)^\alpha\;\mathrm{d} B_\tau
\end{align*}
In particular, since $B^H_{t, t} = B^H_t$ and $B^H_{0, t} = 0 = B^H_0$,
\begin{align*}
    f(t, B^H_t) & = f(0, B^H_0) + \int_{0}^t \frac{\partial f}{\partial \tau}(t, B_{\tau, t})\;\mathrm{d}\tau + \alpha \int_{0}^t \frac{\partial f}{\partial y}(t, B_{\tau, t})\tau^{\alpha - 1} (Y^H_{\tau, t} - Y^H_{\tau, \tau})\;\mathrm{d}\tau \\
    & \quad + \frac{C_H^2}{2}\int_{0}^t \frac{\partial^2 f}{\partial y^2}(t, B_{\tau, t}) (t - \tau)^{2\alpha} \;\mathrm{d}\tau + C_H \int_{0}^t \frac{\partial f}{\partial y}(t, B_{\tau, t})(t - \tau)^\alpha\;\mathrm{d} B_\tau
\end{align*}
...
\begin{align*}
    f(t', B^H_{t'}) - f(t, B^H_{t}) & = f(0, B^H_0) + \int_{0}^t \frac{\partial f}{\partial \tau}(t, B_{\tau, t})\;\mathrm{d}\tau + \alpha \int_{0}^t \frac{\partial f}{\partial y}(t, B_{\tau, t})\tau^{\alpha - 1} (Y^H_{\tau, t} - Y^H_{\tau, \tau})\;\mathrm{d}\tau \\
    & \quad + \frac{C_H^2}{2}\int_{0}^t \frac{\partial^2 f}{\partial y^2}(t, B_{\tau, t}) (t - \tau)^{2\alpha} \;\mathrm{d}\tau + C_H \int_{0}^t \frac{\partial f}{\partial y}(t, B_{\tau, t})(t - \tau)^\alpha\;\mathrm{d} B_\tau
\end{align*}
