...
\end{multline}
provided the right hand side is finite, and where $\odot$ denotes the Hadamard product of two matrices of same dimensions. Recall the steps of the cross variation matrix $[Z, Z]_s$ is positive semi-definite, so the right hand side is nonnegative.
