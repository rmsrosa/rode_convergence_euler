...
\]
implies that each quadratic covariation is a difference of quadratic variations, which are non-decreasing processes, so that each quadratic covariation is also of finite variation.
