...
In the more general case of a semi-martingale noise $\{Y_t\}_{t\geq 0}$, the change of variables formula \cref{changeofvariablesformulacadlagfv} takes the form (see e.g. \cite[Theorems II.32 and II.33]{Protter2005}, \cite[Section 1.3.3]{AitSahaliaJacod2014} and \cite[Theorem 3.6]{KaratzasShreve2014})
\begin{equation}
