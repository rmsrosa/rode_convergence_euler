...
\section{The case of a separable equation with monotonicity}

Here, the noise $\{Y_t\}_{t\in I}$ is \emph{not} assumed to be an It\^o noise, but, instead, that the steps can be controlled by monotonic nondecreasing terms with finite expected growth.
...
\begin{thm}
    Suppose that for some $1\leq p, q \leq \infty$ with $1/p + 1/q = 1$, it holds
    \[
