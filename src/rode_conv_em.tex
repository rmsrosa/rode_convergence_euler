...
\begin{thm}
    Not sure yet but we want to bound
    \begin{equation}
...
\begin{proof}
    For the last term in \eqref{Etjbasicbound}, we use the It\^o formula on $Z_s = f(s, X_t^N, Y_s)$ and write, for any $0 \leq t < t + \tau \leq T$,
    \begin{align*}
