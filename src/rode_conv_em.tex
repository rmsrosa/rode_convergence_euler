...
\]
Only this bounding process $\{\bar F_t\}_{t\in I}$ is required to have sample paths of bounded variation, which is usually easier to check. These two cases are treated in \cref{secmonotonicbound} (see \cref{lemmonotonicbound} and \cref{thmmonotonicbound}) and \cref{secItonoise} (see \cref{lemItostep} and \cref{thmItostep}).
...
\]
hence both are uniformly bounded. Therefore, all the conditions of \cref{thmItonoise} hold and the Euler-Maruyama method is of strong order 1.
