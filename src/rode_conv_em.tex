...
\begin{proof}
    ...
    \]
    Since by assumption $\mathbb{E}[|X_0|^2] < \infty$ and $\mathbb{E}[|Y_t|^2] \leq \mathbb{E}[V(Y_t, T, 0)^2] < \infty$, it follows from \eqref{XtboundLXMt} that
    \[
    ...
    \]
    Any sample path of $\{G_t\}_{t\in I}$ is non-decreasing and $G_0 = 0$. Moreover,
    \[
        \mathbb{E}[G_T] \leq \left(A_T(H_M + H_XK_X) + B_T\right)T + \left(A_Y (H_M + H_XK_X) + B_Y\right)\mathbb{E}[V(Y_t, T, 0)^2].
    \]
