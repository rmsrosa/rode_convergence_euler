...
\begin{lem}
    The Euler-Maruyama approximation \eqref{emscheme} for the random ordinary differential equation \eqref{rodeeq} satisfies the global error formula
    \begin{equation}
...
Here we derive a general estimate that will be the basis for the estimates in specific cases.
