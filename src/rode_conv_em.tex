...
We show that if \textcolor{red}{describe the conditions needed in \cref{secmonotonicbound}}, then 
...
\end{equation}
where $\mathbb{E}[\cdot]$ indicates the expectation of a random variable on $\Omega$ (see \cref{EMstrongorder1}).
...
\begin{enumerate}
  ...
  \item We then use the It\^o isometry to estimate this integral term by $\Delta t_N$;
\end{enumerate}
