...
\]
Instead, we keep the global error formula and assume either of two assumptions on the stochastic process $\{F_t\}_{t \geq 0}$ given by $F_t = f(t, X_{\tau^N(t)}^N, Y_t)$:
\begin{enumerate}
    \item blah
    \item bleh 
\end{enumerate}
