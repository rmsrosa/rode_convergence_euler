...
\begin{equation}
  ...
  X_0^N = X_0.
\end{equation}
Notice both $\Delta t_N = T/N$ and $t_j = t_j^N = j\Delta t_N = jT/N$ depend on $N$, but we sometimes do not make this dependency explicit, for the sake of notational simplicity.
