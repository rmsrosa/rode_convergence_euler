...
\begin{proof}
    ...
    \]
    I believe the estimate on the noise will end up affecting both terms, so we better just take $p=q=2$ and assume that
    \[
        \mathbb{E}[|X_0|^2] < \infty
    \]
    and something like
    \[
        \mathbb{E}\left[\int_0^T |\mathrm{d}Y_\xi|^2\right] < \infty
    \]
\end{proof}
